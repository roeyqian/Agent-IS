  ...
  en: {
    cue_triage: {
      ...
      items: {
        ...
        q3: {
          prompt: "Friends are planning a weekend activity, but the details are still vague. Which image feels closest to your first position?",
          options: {
            A: "A door already half open.",
            B: "A calendar square still in pencil.",
            C: "A battery icon you check before leaving.",
            D: "A message draft waiting for one trusted reply.",
            E: "A table with one empty chair.",
            F: "A checklist folded into a pocket.",
            G: "A song everyone starts before you know the words.",
            H: "A small lamp kept on for someone else.",
          },
        },
        q4: {
        ...
        q5: {
          prompt: "You start learning a new skill. Which object would you rather find on the first page?",
          options: {
            A: "A bright sample you can touch immediately.",
            B: "A quiet preview window.",
            C: "A narrow path with small markers.",
            D: "A shared notebook with comments in the margin.",
            E: "A timer showing that the room is open briefly.",
            F: "A clean template with empty boxes.",
            G: "A soft chair beside the practice space.",
            H: "A second set of headphones.",
          },
        },
        q6: {
        ...
        q8: {
          prompt: "In an unfamiliar street, which sign would pull you first?",
          options: {
            A: "A line moving quickly under warm light.",
            B: "A simple familiar symbol.",
            C: "A board showing distance, wait time, and score.",
            D: "A note left by someone who knows the area.",
            E: "A door that says it closes soon.",
            F: "A plain map with one route circled.",
            G: "A quiet corner that looks easy to enter.",
            H: "A table where people are already sharing plates.",
          },
        },
        q9: {
        ...
        q10: {
          prompt: "At the end of a demanding week, which reset symbol feels closest?",
          options: {
            A: "A curtain opening onto a brighter scene.",
            B: "A room with the noise dial turned down.",
            C: "A desk with every loose paper stacked.",
            D: "A familiar person saving you a seat.",
            E: "A warm drink held with both hands.",
            F: "A single rule written on a sticky note.",
            G: "A button that makes the week feel complete.",
            H: "A small signal sent to someone safe.",
          },
        },
      },
    },
  ...
  zh: {
    cue_triage: {
      ...
      items: {
        ...
        q3: {
          prompt: "朋友们临时提议周末活动，但细节还没完全确定。哪幅画面更接近你最初的位置？",
          options: {
            A: "一扇已经半开的门。",
            B: "还用铅笔写着的日历格。",
            C: "出门前先看的电量图标。",
